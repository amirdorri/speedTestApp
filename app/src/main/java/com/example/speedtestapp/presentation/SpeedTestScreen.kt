package com.example.speedtestapp.presentation
...
import com.example.speedtestapp.model.UiState
import com.example.speedtestapp.ui.theme.DarkGradient
import com.example.speedtestapp.ui.theme.Green200
import com.example.speedtestapp.ui.theme.Pink
...
fun SpeedIndicator(state: UiState, onClick: () -> Unit) {
    Box(
        ...
        SpeedIndicatorCanvas(degree = state.arcValue)
...
@Composable
fun SpeedIndicatorCanvas(degree: Float) {
...
fun DrawScope.drawLines(currentLine: Int) {
    val angleSize = 240f;
    val lines = 40
